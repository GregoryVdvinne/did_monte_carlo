...
Lastly, we have revenue, which is determined as follows. For each store, revenue in each year is drawn from a random normal distribution with a mean of 1 000 000 and a standard deviation of 100 000, plus the effects of being located in an urban area and adopting the technology. The ceteris paribus effect of being located in an urban area is an additional 50 000 per year of revenue, while the ceteris paribus effect of the treatment is an additional 100 000 per year of revenue. This effect is completely homogeneous. 
